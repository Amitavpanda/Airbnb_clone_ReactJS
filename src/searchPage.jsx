...
const SearchPage = () => {
    return ( <
        ...
        <
        p > 50 stays.1 December to 8 December.12 guests < /p> <
        h1 > Stays Nearby < /h1> <
        Button variant = "outined" > Cancellation Flexibility < /Button> <
        Button variant = "outined" > Type of Place < /Button> <
        Button variant = "outined" > Price < /Button> <
        Button variant = "outined" > Rooms and beds < /Button> <
        Button variant = "outined" > More Filters < /Button> <
